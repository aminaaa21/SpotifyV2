...
def open_file(path):
    list_ = []
    with open(path, encoding="mbcs") as csv_file:
...
def individual_choice(spotify_dataset):
        ...
        for song in spotify_dataset:
            ...
            if song == spotify_dataset[-1]:
                ...
                if flag_song_1 == False:
                    song_1 = str(input(f"Sorry, we could not recognise the song {song_1}, could you name another song? "))
                if flag_song_2 == False:
                    song_2 = str(input(f"Sorry, we could not recognise the song {song_2}, could you name another song? "))
                if flag_song_3 == False:
                    song_3 = str(input(f"Sorry, we could not recognise the song {song_3}, could you name another song? "))
    ...
    if songs_5 == 0:
        print("Sorry, we could not find a playlist with the songs you have already heard! But here are 5 songs you have never listened to:")
